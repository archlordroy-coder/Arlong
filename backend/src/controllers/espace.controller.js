...
const getEspaces = async (req, res) => {
  try {
    console.log('getEspaces called, user.id:', req.user?.id);
    
    // Simplified query - avoid complex foreign key relationships
    ...
    console.log('Supabase result:', { data: espaces?.length, error });
